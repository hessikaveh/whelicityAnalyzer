...
config.General.requestName   = 'WWJJ26Feb'
...
config.JobType.psetName = 'test/whelicity_WWJJ_cfg.py'
...
config.Data.inputDataset = '/WWJJToLNuLNu_EWK_13TeV-madgraph-pythia8/RunIISummer16MiniAODv2-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v6-v1/MINIAODSIM'
...
config.Data.outputDatasetTag = 'WWJJMC'
