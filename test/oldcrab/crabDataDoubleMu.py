...
config.JobType.psetName = 'test/whelicity_DataDoubleMu_cfg.py'
...
config.JobType.outputFiles = ['Datatree.root','sanityCheckHistos.root']
...
config.Data.outputDatasetTag = 'RunB'
