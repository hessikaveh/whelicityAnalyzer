...
config.General.requestName   = 'TTProducer'
...
config.JobType.psetName = 'test/whelicity_producer_cfg.py'
...
config.JobType.outputFiles = ['myOutputFile.root']
...
config.Data.outputDatasetTag = 'Producer'
